...
@WebServlet(name = "ServletNotesFolderFilter", urlPatterns = "/FolderFilter")
public class ServletNotesFolderFilter extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String changeToFolder = new String(request.getParameter("changeToFolder").getBytes("iso-8859-1"), "UTF-8");
        String nameUserInSession = (String) session.getAttribute("username");

        String selectedFolder = changeToFolder;
